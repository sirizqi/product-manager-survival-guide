...
I once built what I considered a masterpiece: a prioritization spreadsheet with RICE scores for 47 different request fitur. Reach, Impact, Confidence, Effort—all meticulously scored, weighted, and ranked. I was so proud of this spreadsheet. It had conditional formatting. It had a summary tab. It practically glowed with data-driven objectivity.

I presented it in our planning meeting like I was unveiling scientific proof of what we should build next.

The VP of Sales looked at the #1 ranked item, then looked at me, and said, "That's nice, but we're building the custom integration for [Big Enterprise Client] Pertama, because they threatened to churn, and that's a $2M contract."
...
Here's what nobody tells you in the "Cara prioritize" LinkedIn posts: **the framework was never the hard part. The politics, the power dynamics, and the courage to disappoint people—that's the actual job.** RICE, MoSCoW, Kano, ICE—these are just tools to help you _think_. They Jangan have the authority to make decisions stick. Only relationships, evidence, and sometimes sheer stubbornness can do that.
...
**Where it breaks down:** The "Confidence" score is often just vibes dressed up as a percentage. And it treats all initiatives as directly comparable, when Kenyataannya, a small bug fix and a major platform rebuild shouldn't be scored on the same scale.

### **MoSCoW (Must have, Should have, Could have, Won't have)**

**Best for:** Scoping a specific release or sprint when Kamu perlu quickly separate essential from nice-to-have.
...
Here's the reality that no framework fully solves: you're usually juggling three competing priority systems that Jangan naturally align.
...
**User Priority:** What do actual users need, based on research and data? (Often invisible to leadership because users Jangan have a seat in the roadmap meeting.)
...
In an ideal world, these three would perfectly overlap. Kenyataannya,, they're often in tension, and part of your job is navigating—not eliminating—that tension.
...
**Cara handle it (without career suicide):** Jangan dismiss the input—that's a fast way to lose trust and get bypassed in future decisions. Instead, take the concern seriously, then bring data into the conversation. "That's an interesting move by [Competitor]. Let me look into why they might have built that and whether our users are asking for something similar." Sometimes you'll find the HiPPO's instinct was actually right (executives do have pattern recognition from experience). Sometimes you'll find data that respectfully redirects the conversation. Either way, you've engaged rather than dismissed, which preserves your relationship and credibility.
...
I chose a Ketiga, option: I brought data, not opinions. I built a simple one-pager showing projected impact (using the same rigor we'd apply to any other feature), user research explicitly contradicting the assumed demand, and an honest opportunity cost analysis of what else that 40% of engineering capacity could accomplish instead.
...
**Daripada asking:** "Should we build Feature X?" (a yes/no question that hides the real trade-off)
...
**1. Gather inputs from multiple sources** (user research, data, stakeholder requests, technical debt needs, competitive intelligence)—Jangan let any single source dominate by default.
...
**4. Protect technical debt capacity systematically**, not as an afterthought competing against every shiny request fitur.
...
Prioritization frameworks (RICE, MoSCoW, Kano, ICE) are useful thinking tools, but they can be gamed, and they Jangan have the authority to make decisions stick on their own—only relationships, evidence, and organizational courage can do that.
...
2. Has your organization ever labeled "everything" as high priority? What happened Hasilnya,?
3. How much of your engineering capacity is protected for technical debt versus competing quarter-by-quarter against request fitur?
